...
def generate_gemini_comment(image_pil, expiry, batch, yolo_detections):
    try:
        prompt = f"""
You are a medicine quality inspector.
...
TASK:
1. Start with a short summary with clearly labeled fields:
   - Damage: Yes/No
   - Expiry Date
   - Batch Number
   - Verdict: Acceptable / Needs to be returned / Unacceptable

2. After the summary, provide a professional detailed explanation.
